defmodule YapWeb.Router do
  ...
  scope "/", YapWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{YapWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", YapWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{YapWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", YapWeb do
    ...
    live_session :current_user,
      on_mount: [{YapWeb.UserAuth, :mount_current_user}] do
